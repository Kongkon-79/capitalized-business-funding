...
const Message = () => {
    return (
        <div className='p-4 md:p-1'>
            ...
            <h2 className='text-5xl lg:text-6xl font-bold leading-[40px] text-secondary-100 text-center pb-10'>Great Job!</h2>
            <p className='text-base md:text-lg font-normal text-secondary leading-[32p]x text-center'>Our Funding Specialists are working on your funding terms and will touch base shortly.</p>
