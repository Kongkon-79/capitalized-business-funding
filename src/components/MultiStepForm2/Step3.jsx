        ...
        <div className='bg-white rounded-xl p-[24px] md:p-[28px] lg:p-[32px] mb-10 md:mb-14 lg:mb-20'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 lg:gap-10 pt-4 md:pt-6 lg:pt-8'>
                ...
                <div className='md:col-span-1'>
                    <label className='text-xl md:text-2xl font-medium leading-[24px] text-secondary-100' htmlFor="businessDBA">Business DBA</label> <br />
                    <input className='w-full py-[11px] px-[12px] rounded-[4px] border border-[rgba(34,66,96,0.50)] mt-[8px] md:mt-[12px] lg:mt-[16px] outline-primary mb-1' type='text' {...register("businessDBA", { required: "Business DBA is Required" })}
                ...
                <div className='md:col-span-1'>
                    <label className='text-xl md:text-2xl font-medium leading-[24px] text-secondary-100' htmlFor="zipCodeB">Zip Code</label> <br />
                    <input className='w-full py-[11px] px-[12px] rounded-[4px] border border-[rgba(34,66,96,0.50)] mt-[8px] md:mt-[12px] lg:mt-[16px] outline-primary mb-1' type='text' {...register("zipCodeB", { required: "Zip Code is Required" })}
