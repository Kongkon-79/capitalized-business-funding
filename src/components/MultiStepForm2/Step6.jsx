...
const Step6 = ({ handlePreviousStep, handleNextStep }) => {
    ...
    return (
        <div className='bg-white rounded-xl p-[24px] md:p-[28px] lg:p-[32px] mb-10 md:mb-14 lg:mb-20'>
            <h4 className='text-2xl md:text-3xl font-semibold leading-[30px] md:leading-[36px] text-secondary pt-6 pb-3'>Thank you for completing your application. You only have one step left.</h4>
            <p className='text-base md:text-lg font-normal leading-[26px] text-secondary/50 pb-3'>In order to validate the funding approval, we need to review your most recent bank statements. Please complete the validation below, and your bank statements will automatically be sent to us.</p>
            <p className='text-base md:text-lg font-normal leading-[26px] text-secondary/50'>This is your primary business bank account that we will be depositing funds into.</p>
            ...
            {/* button  */}
            <div className='flex items-center justify-between pt-[30px] lg:pt-[40px]'>
