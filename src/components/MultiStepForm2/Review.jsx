    ...
    return (
        <div>
            ...
            >
                {
                    reviewData.map((data) => {
                        return <SwiperSlide key={data?.id} className='bg-white p-[16px] lg:p-[20px] rounded-md'>
                            <div  >
                                <div className='flex items-center gap-[17px]'>
                                    <div>
                                        <img src={data?.img} alt='sunny' width={117} height={117} className='w-[100px] md:w-[117px] h-[100px] md:h-[117px] rounded-full'/>
                                    </div>
                                    <div>
                                ...
                                <p className='text-base font-normal text-secondary leading-[20px] pt-[20px] md:pt-[30px] lg:pt-[38px] '>{data?.review}</p>
                            </div>
                        </SwiperSlide>
                    })
                }
