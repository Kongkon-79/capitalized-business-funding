...
const Step1 = ({ handlePreviousStep, handleNextStep }) => {
    ...
    return (
        <div className='bg-white rounded-xl p-[24px] md:p-[28px] lg:p-[32px] mb-10 md:mb-14 lg:mb-20'>
            <div>
                <h3 className='text-2xl md:text-3xl lg:text-4xl font-medium leading-[30px] md:leading-[40px] text-primary pb-[8px]'>Let's get your specific funding terms buttoned up.</h3>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 lg:gap-10 pt-4 md:pt-6 lg:pt-8'>
                <div className='md:col-span-1'>
                    <label className='text-xl md:text-2xl font-medium leading-[24px] text-secondary-100' htmlFor="firstName">First Name</label> <br />
                    <input className='w-full py-[11px] px-[12px] rounded-[4px] border border-[rgba(34,66,96,0.50)] mt-[8px] md:mt-[12px] lg:mt-[16px] outline-primary mb-1' type='text' {...register("firstName", { required: "First Name is Required" })}
                ...
                <div className='md:col-span-1'>
                    <label className='text-xl md:text-2xl font-medium leading-[24px] text-secondary-100' htmlFor="lastName">Last Name</label> <br />
                    <input className='w-full py-[11px] px-[12px] rounded-[4px] border border-[rgba(34,66,96,0.50)] mt-[8px] md:mt-[12px] lg:mt-[16px] outline-primary mb-1' type='text' {...register("lastName", { required: "Last Name is Required" })}
                ...
                <div className='md:col-span-1'>
                    <label className='text-xl md:text-2xl font-medium leading-[24px] text-secondary-100' htmlFor="email">Email Address</label> <br />
                    <input className='w-full py-[11px] px-[12px] rounded-[4px] border border-[rgba(34,66,96,0.50)] mt-[8px] md:mt-[12px] lg:mt-[16px] outline-primary mb-1' type='email' {...register("email", { required: "Email Address is Required" })}
                ...
                <div className='md:col-span-1'>
                    <label className='text-xl md:text-2xl font-medium leading-[24px] text-secondary-100' htmlFor="phoneNumber">Phone Number</label> <br />
                    <input className='w-full py-[11px] px-[12px] rounded-[4px] border border-[rgba(34,66,96,0.50)] mt-[8px] md:mt-[12px] lg:mt-[16px] outline-primary mb-1' type='text' {...register("phoneNumber", { required: "Phone Number is Required" })}
